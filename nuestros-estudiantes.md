...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 30px;">
  ...
  <div id="luciano" class="alumnos-block">
    ...
    <blockquote>
        ...
        <em>Estudiante de Licenciatura</em>
  ...
  <div id="angelPorras" class="alumnos-block">
    ...
    <blockquote>
        ...
        <div class="has-text-justified">
            <strong class="has-text-primary">Proyecto de Tesis:</strong><br/>
            <em>Simulación Numérica de la Marea de Tormenta del Huracán Milton</em><br/><br/>
            <!-- <strong class="has-text-primary">Beca:</strong> <em>Beca para titulación del proyecto PAPIIT-2025 Clave IA100225</em><br/><br/> -->
            <strong class="has-text-primary">Director:</strong> <em><a href="{{ site.baseurl }}/planta-academica/drsalcedo">Dr. Erick Salcedo Álvarez</a></em>
        </div>
    </blockquote>
  </div>
  <div class="alumnos-block">
    ...
    <blockquote>
        <strong class="has-text-primary">Litza Xaya Vences Juárez</strong>
        <em>Estudiante de Licenciatura</em>
  ...
  <div class="alumnos-block">
    ...
    <blockquote>
        <strong class="has-text-primary">Fernando Aguilar Reyes</strong>
        <em>Estudiante de Licenciatura</em>
        <em>ENES Unidad Mérida - UNAM</em><br/>
        <strong class="has-text-primary">Tesista</strong><br/>
        <div class="has-text-justified">
  ...
  <div class="alumnos-block">
    ...
    <blockquote>
        <strong class="has-text-primary">Betsheba Patricia Hernández Loera</strong>
        <em>Estudiante de Licenciatura</em>
        <em>ENES Unidad Mérida - UNAM</em><br/>
        <div class="has-text-justified">
  ...
  <div class="alumnos-block">
    ...
    <blockquote>
        <strong class="has-text-primary">Ailyn Leticia Mendoza Osorno</strong>
        <em>Estudiante de Licenciatura</em>
        <em>ENES Unidad Mérida - UNAM</em><br/>
        <div class="has-text-justified">
            <strong class="has-text-primary">Modalidad de Titulación:</strong><br/>
  ...
  <div class="alumnos-block">
    ...
    <blockquote>
        <strong class="has-text-primary">Monica Marisol Carrillo Monsrreal</strong>
        <em>Estudiante de Doctorado</em>
        <em>ESIME - IPN</em><br/>
        <strong class="has-text-primary">Tesista</strong><br/>
        <div class="has-text-justified">
            <strong class="has-text-primary">Proyecto de Tesis:</strong><br/>
